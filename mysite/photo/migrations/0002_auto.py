...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field pics on 'Album'
        m2m_table_name = db.shorten_name(u'photo_album_pics')
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field pics on 'Album'
        db.delete_table(db.shorten_name(u'photo_album_pics'))
    ...
    models = {
        ...
        u'photo.album': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'pics': ('django.db.models.fields.related.ManyToManyField', [], {'blank': 'True', 'related_name': "'Gallery'", 'null': 'True', 'symmetrical': 'False', 'to': u"orm['photo.Image']"}),
